...
const Cards = () => {
    return (
        <>
            <div className="container flex-col px-5 py-24 mx-auto md:flex-row flex-1 flex gap-5">
                ...
                <div className="relative transform transition-transform duration-500 hover:scale-105 lg:w-1/3 w-full mb-10 lg:mb-0 overflow-hidden shadow-inner">
                    <video
                        preload='auto'
                        autoPlay
                        loop
                    ...
                    <div className="absolute bottom-10 inset-0 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-500">
                        <button className="text-black shadow-lg bg-white border-0 py-2 px-6 focus:outline-none hover:bg-black hover:text-white rounded text-lg transition-colors duration-500 mx-2">
                            SHOP MEN
                        </button>
                        <button className="inline-flex text-black shadow-lg bg-white border-0 py-2 px-6 focus:outline-none hover:bg-black hover:text-white rounded text-lg transition-colors duration-500 mx-2">
                            SHOP WOMEN
